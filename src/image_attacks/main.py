...
if __name__ == '__main__':
    ...
    subprocess.call(['./parallelize_im2proba.sh', cores, city])    #downloads images and converts to embeddings, shell script calls im2proba.py
    ...
    allPairs = make_allPairs("avg_pairs.csv", u_list_file=counts_file, DATAPATH=DATAPATH, friendFile=city + ".target_friends", makeStrangers=True)

    dataset = make_dataset_counts(DATAPATH, clean_file, DATAPATH + "supervised_ensemble2/im_dataset.csv", counts_file, allPairs)
